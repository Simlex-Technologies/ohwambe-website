...
type Props = {
   ...
   */
    ...
    /**
     * The class name for the modal wrapper (optional prop)
     */
    modalWrapperClassName?: string
}

const ModalWrapper = ({ visibility, setVisibility, children, disallowOverlayFunction, modalWrapperClassName }: Props) => {
    return (
        <motion.div
            initial="closed"
            animate={visibility ? "opened" : "closed"}
            className={`fixed w-full h-full top-0 left-0 z-30 flex items-center justify-center ${!visibility && 'pointer-events-none'} ${modalWrapperClassName}`}>
